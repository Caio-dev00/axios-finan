...
const IncomePage = () => {
  ...
  return <div className="container mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <AddIncomeDialog trigger={<Button className="flex items-center gap-2">
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? <div className="flex justify-center items-center py-8">
              ...
              </div> : incomes && incomes.length > 0 ? <div className="space-y-4">
                {incomes.map(income => <div key={income.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-md">
                    <div>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction className="bg-red-600 text-white hover:bg-red-700" onClick={() => handleDeleteIncome(income.id)}>
                              Excluir
                            </AlertDialogAction>
                          </AlertDialogFooter>
                        </AlertDialogContent>
