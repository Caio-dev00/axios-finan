        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/planos" className="text-gray-400 hover:text-white transition-colors">Planos</Link></li>
              <li><Link to="/dicas" className="text-gray-400 hover:text-white transition-colors">Dicas Financeiras</Link></li>
              <li><Link to="/relatorios" className="text-gray-400 hover:text-white transition-colors">Relatórios</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/ajuda" className="text-gray-400 hover:text-white transition-colors">Ajuda</Link></li>
